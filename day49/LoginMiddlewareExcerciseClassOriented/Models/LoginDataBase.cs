namespace LoginMiddlewareExcerciseClassOriented.Models
{
    public class LoginDataBase
    {
        ...
        public IDictionary<string, string> userDatabase()
        {
            ...
            userDataBase.Add(new KeyValuePair<string, string>("Sachin", "Password"));
            userDataBase.Add(new KeyValuePair<string, string>("akhilesh", "Password"));
            userDataBase.Add(new KeyValuePair<string, string>("venkat", "Password"));
