...
{
    internal class EmployeeFileRead
    {
        public HashSet<Employee> ReadFromCSVFile(string filePath)
        {
            ...
            while (true)
            {
                ...
                uniqueEmployee.Add(new Employee { EmpNo = empNo, EmployeeName = empName, EmployeeJob = empJob, EmployeeMGRID = empMGRid, DateofJoining = empDOJ, EmployeeSalary = empSAL, EmployeeCommision = empCOMM, EmployeeDepartmentNo = empCOMM });
